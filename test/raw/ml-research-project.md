...
- Fine-tuned LLM embeddings on 1.2M scientific abstracts, reducing retrieval latency by 30%.
- Co-authored a workshop paper submitted to NeurIPS 2025 and presented results to a lab of 20 researchers.
- Tools: Python, PyTorch, Hugging Face, FAISS, SQL.
